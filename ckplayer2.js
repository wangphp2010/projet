...
function ckplayerConfig() {
	return {
		...
		config: {
			...
			//这里设置多段加载数！
			loadNext: 15, //多段视频预加载的段数，设置成0则全部加载
			...
			//这里可以设置码率的关键字，中文在ckPlayer.xml文件里面。
			m3u8Definition: { //m3u8自动清晰度时按关键字来进行判断
				//tags:['200k','110k','400k','600k','1000k']
			},
			//这里最重要，分段基本不动，缓冲时间根据切片大小来设置！
		...
		style: { //风格部分内容配置，这里主要配置loading和logo以及广告的部分内容
			//这里是load加载动画，不要可以删除掉。注意，请整段删除，否则播放器会报错。
		 	loading: {
			...
			//这里是右上角logo，不要可以删除掉，注意，请整段删除，否则播放器会报错。
			logo: {
				file: 'data:img/jpg;base64,',
				align: 'right',
				vAlign: 'top',
				offsetX: -105,
				offsetY: 3
